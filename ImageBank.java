...
/**
 * A repository of all the image objects needed throughout Jned. Rather than load mulitple instances
 * of images or intersperse file handling and image loading code throughout, all images are loaded
 * once into a single array at startup. Whenever an object needs an image, it can simply request it
 * from ImageBank using one of ImageBank's static fields.
 * <p>
 * In addition, ImageBank carries offset data for images of level items. To draw itself on the
 * level, an Item can request its image and its x and y image offset values using the same fields.
 * @author James Porter
 */
public class ImageBank {
  private BufferedImage[] images;
  // Indices for x and y offset arrays match the first two sets of fields below 
  private int[] xs = {-6, -6, -4, -6, -10, -10, -10, -10, -9, -9, -9, -9, -9, -9, -9, -9, -9, -9,
      -9, -9, -9, -9, -9, -9, -4, -3, -10, -13, -6, 7, -12, -12, -12, -2, -12, 0, -12,22, 0, 0, 0,
      -4, 19, 0, 0, 0, -3, 0, -9, -7, -9, -5, -9, -7, -9};             
  private int[] ys = {-6, -6, -4, -6, -10, -10, -10, -10, -9, -9, -9, -9, -15, -15, -15, -15, -9,
      -9, -9, -9, -9, -9, -9, -9, -11, -3, -10, -12, -4, -12,7, -12, -12, -12, -2, -12, 0, 0, 22, 0,
      0, -4, 0, 19, 0, 0, -3, -7, -9, 0, -9, -7, -9, -5, -9};
  ...
  public static final int THWUMP = 4; // 4 directions
  public static final int ZAP = 8; // 4 directions
  public static final int SEEKER = 12; // 4 directions
  public static final int LASER = 16; // 4 directions
  public static final int CHAINGUN = 20; // 4 directions
  // Items
  public static final int PLAYER = 24;
  public static final int GOLD = 25;
  public static final int BOUNCE = 26;
  public static final int EXIT = 27; // Door/switch
  public static final int ONEWAY = 29; // 4 directions
  public static final int NDOOR = 33; // 4 directions
  public static final int LDOOR = 37; // 4 directions, switch
  public static final int TDOOR = 42; // 4 directions, switch
  public static final int LAUNCH = 47; // 8 directions
  // Tiles
  public static final int TILE45 = 55; // 4 directions
  public static final int THIN63 = 59; // 4 directions
  public static final int THIN27 = 63; // 4 directions
  public static final int CONCAVE = 67; // 4 directions
  public static final int HALF = 71; // 4 directions
  public static final int THICK63 = 75; // 4 directions
  public static final int THICK27 = 79; // 4 directions
  public static final int CONVEX = 83; // 4 directions
  public static final int FILL = 87;
  public static final int ERASE = 88;
  // BUTTONS -- Every button has a pushed and unpushed image
  // Enemies
  public static final int BT_GAUSS = 89;
  public static final int BT_HOMING = 91;
  public static final int BT_MINE = 93;
  public static final int BT_FLOOR = 95;
  public static final int BT_THWUMP = 97; // 4 directions
  public static final int BT_ZAP = 105; // 6 behaviors, 4 directions
  public static final int BT_SEEKER = 125; // 6 behaviors, 4 directions
  public static final int BT_LASER = 145; // 6 behaviors, 4 directions
  public static final int BT_CHAINGUN = 165; // 6 behaviors, 4 directions
  // Items
  public static final int BT_PLAYER = 185;
  public static final int BT_GOLD = 187;
  public static final int BT_BOUNCE = 189;
  public static final int BT_EXIT = 191;    
  public static final int BT_ONEWAY = 193; // 4 directions
  public static final int BT_NDOOR = 201; // 4 directions
  public static final int BT_LDOOR = 209; // 4 directions, super
  public static final int BT_TDOOR = 219; // 4 directions, super
  public static final int BT_LAUNCH = 229; // 8 directions, teleporter
  // Tiles
  public static final int BT_TILE45 = 247; // 4 directions
  public static final int BT_THIN63 = 255; // 4 directions
  public static final int BT_THIN27 = 263; // 4 directions
  public static final int BT_CONCAVE = 271; // 4 directions
  public static final int BT_HALF = 279; // 4 directions
  public static final int BT_THICK63 = 287; // 4 directions
  public static final int BT_THICK27 = 295; // 4 directions
  public static final int BT_CONVEX = 303; // 4 directions
  public static final int BT_FILL = 311;
  public static final int BT_ERASE = 313;
  // Other
  public static final int BT_DOWN_ARROW = 315;
  
  /**
   * Constructs a new ImageBank, loading all of the images from files into an array of
   * BufferedImages.
   */
  public ImageBank () {
   ...
   * @param index the index of desired image. Indices correspond to one of ImageBank's static
   * fields.
   * @return the BufferedImage at the specified index, or null if index is invalid or image loading
   * failed.
   */
  ...
  /**
   * Retrieves the x offset for the specified image.
   * @param index the index of desired image. Indices correspond to one of ImageBank's static
   * fields for level items.
   * @return the x offset for the specified image, or where to draw the left side of the image
   * relative to the x coordinate of the object
   */
  ...
  /**
   * Retrieves the y offset for the specified image.
   * @param index the index of desired image. Indices correspond to one of ImageBank's static
   * fields for level items.
   * @return the y offset for the specified image, or where to draw the top of the image relative 
   * to the y coordinate of the object
   */
